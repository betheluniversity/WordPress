...
function twentyeleven_setup() {
	...
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyeleven_header_image_height', 196 ) );
...
function twentyeleven_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="by-author"> by <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'twentyeleven' ),
...
function remove_submenu() {
  ...
  //remove theme options for Bethel
  ...
  echo '
    <script type="text/javascript">
     jQuery(document).ready(function($){
        ...
        $("#comments_notify").attr("readonly","readonly");
     });
    </script>
';
}
...
//stops bots and scripts from injecting comments directly into our WordPress comment system, for the Bethel theme.
