...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<h3 id="comments"><?php comments_number(__('No Comments', 'framework'), __('One Comment', 'framework'), __('% Comments', 'framework')); ?> <?php _e('on', 'framework') ?> &quot;<?php the_title(); ?>&quot;</h3>
...
<?php endif; ?>
	...
	<div id="respond">
		...
		<h3><?php comment_form_title( __('Add your comment', 'framework'), __('Leave a Reply to %s', 'framework') ); ?></h3>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<p><input class="button-3-big" name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" />
