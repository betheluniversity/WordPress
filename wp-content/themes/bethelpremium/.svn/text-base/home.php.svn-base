<?php get_header(); ?>
<?php 
/*To get a custom home page, a "Home" category must be created, and then the posts that need to be displayed must be assigned to it  */
			...
			<div id="content-wrap" class="clearfix">
				...
				<div id="primary" class="hfeed">
					...
					<div id="post-0" <?php post_class(); ?>>
						...
						<h2 class="entry-title">Welcome to the <?php bloginfo('name');?> Blog</h2>
					
						<!--BEGIN .entry-content-->
						<div class="entry-content">
							<p><?php _e("There are currently no posts in the Home category", "framework") ?></p>
							<?php get_search_form(); ?>
						<!--END .entry-content-->
						</div>
