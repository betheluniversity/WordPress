...
if ( $image ) {
	...
	$logo = "<span class='screen-reader-text'>" . esc_html( get_bloginfo( 'name' ) ) . "</span><img id='logo' class='logo' src='" . str_replace( 'http://', 'https://',esc_url( get_theme_mod( 'logo_upload' )) ) . "' alt='" . esc_attr( $image_alt ) . "' />";
} else {
